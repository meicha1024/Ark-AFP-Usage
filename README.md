...
**状态栏**：在底部状态栏实时显示各时间窗口的 AFP 使用率，超额风险自动变色。

![状态栏](./images/statusbar.png)

**鼠标悬停**：以表格展示套餐、模型档位、各窗口已用 / 总额度、使用率与重置倒计时。

![悬停用量表格](./images/tooltip.png)

**用量详情**：点击状态栏打开仪表盘，查看额度卡片、进度条、重置时间与倒计时。

![用量详情仪表盘](./images/dashboard.png)
